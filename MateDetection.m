...
net = MateNet( {
  ...
  MateConvLayer(f*randn(5,5,10,25, 'single'), zeros(1, 25, 'single'), ...
                'stride', 1, 'pad', 0, 'weightDecay', [0.005 0.005])
  MatePoolLayer('pool',[2 2], 'stride', 2, 'pad', 0)  
  MateConvLayer(f*randn(4,4,25,250, 'single'), zeros(1, 250, 'single'), ...
                'stride', 1, 'pad', 0, 'weightDecay', [0.005 0.005])  
  MateReluLayer
  MateFlattenLayer
  MateFullLayer(f*randn(2,250, 'single'), zeros(2,1, 'single'),... 
